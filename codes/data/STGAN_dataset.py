...
class STGANDataset(data.Dataset):
    def __init__(self, opt):
        super(STGANDataset, self).__init__()
        self.opt = opt
        ...
        self.LQ_env, self.Ref_DUX4_env, self.LQ_UX4_env, self.Ref_env, self.GT_env = None, None, None, None, None  # lmdb的环境
